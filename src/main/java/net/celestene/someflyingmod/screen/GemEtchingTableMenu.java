...
public class GemEtchingTableMenu extends AbstractContainerMenu {
    ...
    public GemEtchingTableMenu(int pContainerID, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public GemEtchingTableMenu(int pContainerID, Inventory inv, BlockEntity be, ContainerData data) {
        super(ModMenuTypes.GEM_ETCHING_TABLE_MENU.get(), pContainerID);
        checkContainerSize(inv, 2);
        blockEntity = ((GemEtchingTableEntity) be);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.GEM_ETCHING_TABLE.get());
    }
